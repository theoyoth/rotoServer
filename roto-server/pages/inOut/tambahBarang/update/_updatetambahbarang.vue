        ...
        <div>
            <div class="grid grid-cols-3 grid-rows-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" v-model="updateTambahBarang.namaPenambah" name="namaPenambah" id="namaPenambah" class="p-2 w-72 rounded-lg outline-none bg-gray-300 uppercase">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" v-model="updateTambahBarang.penanggungJawab" name="penanggungJawab" id="penanggungJawab" class="p-2 w-72 rounded-lg outline-none bg-gray-300 uppercase">
                </div>
            </div>
        </div>
