        ...
        <div class="grid grid-cols-2">
            <div>
                <div class="has-tooltip ">
                    <span class="tooltip text-xs rounded shadow-lg p-1 bg-gray-700 text-white ml-40">masukan nama produk</span>
                   
                    <label for="produk" class="block mb-2 text-sm">produk</label>
                    <input type="text" name="produk" id="produk" class="p-2 w-72 rounded-lg outline-none bg-gray-200" focus:ring-blue-500 v-model="inputServer.produk" >
            ...
            <div>
                <div class="has-tooltip ">
                    ...
                    <input type="text" name="merek" id="merek" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.merek" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="model" id="model" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.model" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="processor" id="processor" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.processor" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="memori" id="memori" class="p-2 w-72 rounded-l-lg outline-none bg-gray-200" v-model="inputServer.memori" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="internalStorage" id="internalStorage" class="p-2 w-72 rounded-l-lg outline-none bg-gray-200" v-model="inputServer.internalStorage" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="networkController" id="netwokController" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.networkController" >
                </div>
            </div>
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="text" name="storage" id="storage" class="p-2 w-72 rounded-l-lg outline-none bg-gray-200" v-model="inputServer.storage" >
            ...
            <div>
                <div class="has-tooltip relative">
                    ...
                    <input type="text" name="sumberDayaListrik" id="sumberDayaListrik" class="p-2 w-72 rounded-lg outline-none bg-gray-200 bg-gray-200" v-model="inputServer.sumberDayaListrik" >
            ...
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="date" name="tahun" id="tahun" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.tahun" >
                </div>
            </div>
            <div>
                <div class="has-tooltip">
                    ...
                    <input type="date" name="garansi" id="garansi" ref="garansi" class="p-2 w-72 rounded-lg outline-none bg-gray-200" v-model="inputServer.garansi" >
                </div>
            </div>
        </div>
        <button class="bg-gray-700 text-gray-200 rounded-lg w-28 h-10 mt-8 transition duration-300 ease-in hover:shadow-lg" type="submit">kirim</button>
    </form>
</section>
</div>
</template>
