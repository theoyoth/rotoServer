        ...
        <div>
            <div class="grid grid-cols-2">
                <div class="mb-4 has-tooltip">
                    ...
                    <input type="text" v-model="inputCctv.merek" name="merek" id="merek" class="p-2 w-72 rounded-lg focus:ring-blue-500 bg-gray-200">
                ...
                <div class="mb-4 has-tooltip">
                    ...
                    <input type="text" v-model="inputCctv.model" name="model" id="model" class="p-2 w-72 rounded-lg focus:ring-blue-500 bg-gray-200">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" v-model="inputCctv.garansi" name="garansi" id="garansi" class="p-2 w-72 rounded-lg focus:ring-blue-500 bg-gray-200">
                </div>
