...
<div class="bg-bg-gen min-h-screen">
    ...
    <form action="/server/master/inputgenset" method="post" class="w-11/12">
        <div >
            <div class="grid grid-cols-3 grid-rows-4">
                ...
                <div class="mb-4 has-tooltip">
                    ...
                    <input type="text" v-model="tipe" name="tipe" id="tipe" class="p-2 w-72 rounded-lg outline-none" required>
                </div>
                <div class="mb-4 has-tooltip">
                ...
                <div class="mb-4 has-tooltip">
                    ...
                    <input type="date" v-model="garansi" name="garansi" id="garansi" class="p-2 w-72 rounded-lg outline-none" required>
                </div>
            </div>
        </div>
