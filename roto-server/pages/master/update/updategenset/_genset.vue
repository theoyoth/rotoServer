        ...
        <div>
            <div class="grid grid-cols-3 grid-rows-4">
                <div class="mb-4">
                    ...
                    <input type="text" v-model="updateGenset.merek" name="merek" id="merek" class="p-2 w-72 rounded-lg outline-none bg-gray-300">
                </div>
                <div class="mb-4">
                    <label for="model" class="block mb-2 text-sm">model</label>
                    <input type="text" v-model="updateGenset.model" name="model" id="model" class="p-2 w-72 rounded-lg outline-none bg-gray-300">
                </div>
                <div class="mb-4">
                    <label for="tipe" class="block mb-2 text-sm">tipe</label>
                    <input type="text" v-model="updateGenset.tipe" name="tipe" id="tipe" class="p-2 w-72 rounded-lg outline-none bg-gray-300">
                </div>
                <div class="mb-4">
  ...
  data(){
    ...
    async mounted(){
        try{
            ...
            const resp = await axios.get(`http://localhost:3000/server/master/genset/update/${id}/${lokasi}`) 
            if(resp){
     ...
     methods: {
        async updateDataGenset(){
            const resp = await axios.post('http://localhost:3000/server/master/genset/update',{
