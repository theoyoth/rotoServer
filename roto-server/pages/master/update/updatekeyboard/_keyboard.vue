<template>
  <div class="bg-gray-300 min-h-screen w-widthContent ml-auto">
    ...
    <form @submit.prevent="updateDataKeyboard" class="w-11/12 mt-10">
        ...
        <button class="opacity-10 bg-gray-700 text-gray-300 shadow-md rounded-lg w-28 py-2 mt-6" type="submit" :class="{activesubmit : valid}" :disabled="invalid">kirim</button>
    </form>
    </ValidationObserver>
</section>
</div>
